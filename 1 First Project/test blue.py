...
class ColorChangingShape(Scene):
    def __init__(self):
        super().__init__()
        self.colors = [BLUE, DARK_BLUE, PURE_BLUE, BLUE_E, TEAL]
        self.directions = [
                        RIGHT * 5, 
                        RIGHT * 5, 
                        DOWN * 4, 
    ...
    def construct(self):
        ...
        colors = [BLUE, DARK_BLUE, PURE_BLUE, BLUE_A, TEAL]
        ...
        building.set_fill(BLUE, opacity=0.5)
        ...
        tree_trunk = Rectangle(height=1, width=0.2, color=LOGO_BLUE)
        tree_trunk.set_fill(DARK_BLUE, opacity=1)
        tree_trunk.move_to(DOWN * 2.5)

        tree_leaves = Triangle(color=BLUE_E)
        tree_leaves.set_fill(BLUE_C, opacity=1)
        ...
        pillow = RoundedRectangle(
            width=1, height=0.2, corner_radius=0.2, color=PURE_BLUE, fill_opacity = 0.8
        )
